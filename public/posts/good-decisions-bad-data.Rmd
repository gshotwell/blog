...
However, if we think through the totalily of the evidence, as well as the expected value of our actions, we can usually make high quality, calculated decisions instead of waiting for more evidence. 
