...
You would have a small, unknown chance of winning a million dollars, but the ticket doesn't cost anything.
...
This is what caused most public health agencies in the west to doubt the efficacy of cloth face masks, there wasn't any evidence that they really helped with Covid, and so in the absence of evidence they didn't recommend them.
Most of these agencies have come around to the idea that while face masks have a low probability of meaningfully changing the outbreak, we should still wear them because they are free lottery tickets. 
It would be fantastic if they helped prevent outbreaks, but there's no real cost if they  don't work.
...
we have some trials which show that masks prevent influenza and other respiratory ailments and so we should have a prior belief that they will also help with Covid-19. 
...
This is to say that while there's no strong evidence that universal masking prevents similar illnesses, there's some evidence so why not wear a mask?

The evidence that vitamin D prevents respiratory illnesses is stronger because it's been more widely studied.
...
They're important because it helps debunk correlations which might appear in the data which aren't really possible.
Mechanistic studies can only show you that a causal relationship is plausible, not that it actually exists.
We have a [few mechanistic studies](https://www.medrxiv.org/content/10.1101/2020.04.02.20051177v1) of masks and Covid which show that cloth masks can block droplet particles when people speak or cough.
...
It's possible that the virus is transmitted through droplets that are blocked by the mask, but it's also possible that it's transmitted by smaller particles which aren't blocked by it.
...
These are all [processes](https://www.nature.com/articles/s41430-020-0661-0) which involve vitamin D, and for which supplementation has been helpful  but we don't know whether supplementation of Covid-19 patients will actually improve anything.
...
The problem with observational studies it that it's hard to control for confounding variables, and so it's pretty common for there to be a strong relationship in an observational study which disappears when you do a randomized controlled trial. 

There are no strong observational studies that wearing masks prevents Covid. 
Nobody has found that mask wearers are under represented amond Covid patients, or that people who don't wear masks are over represented.
...
People who contracted Covid from a mask wearing loved one, may be less likely to report that fact than those who didn't contract it. 
...
Masks are more or less risk free, although we could imagine that people might attend larger events because "everyone was wearing a mask", or a severely asthmatic person may wear and mask while exercising and experience complications.
...
The number of vitamin D trials over the last 15 years provide a lot of confidence that doses less than 4,000 IU per day are safe in all populations, and doses higher than that are safe when patients are [monitored by physicians](https://www.preprints.org/manuscript/202005.0265/v1). 
