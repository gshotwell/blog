...
For example imagine if you had a dataset that showed a significant relationship between maternal weight,
and a child's birth weight. 
...
There's no common genetic pattern that unites all black and brown people in Northern countries, 
and so it's hard to imagine a mechanism whereby the virus itself is picking out people of colour. 
Whatever effect race has on mortality is probably mediated by something like medical bias or proximity to the virus.
So when a study says that race is a significant predictor after controlling for *x*, *y*, and *z*, 
that means that we're probably missing a causal factor. 
