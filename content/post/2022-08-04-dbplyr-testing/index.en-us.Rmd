...
But I also want to generate SQL so that I can use it to communicate with the people who maintain the database.
...
For example if you noticed odd results when running the query against the actual database you can send them the specific query which no longer produces the expected output along with the output that it used to produce.
